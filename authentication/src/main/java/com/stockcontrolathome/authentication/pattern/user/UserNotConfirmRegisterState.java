...
public class UserNotConfirmRegisterState extends UserLoginState{
    ...
    public void checkState(User user) {
        ...
        if(confirmRegistrationTokenResponse.getExpiredDate().isAfter(now)){
            ...
            this.confirmRegistrationTokenService.renewConfirmRegistrationToken(user.getEmail(), confirmRegistrationTokenResponse.getToken(), EAuditoryConfirmRegistrationTokenState.ELIMINADO_POR_EXPIRACION );
    ...
    public void resendToken(User user) {
        ...
        if(confirmRegistrationTokenResponse.getExpiredDate().isAfter(now)){
            this.confirmRegistrationTokenService.renewConfirmRegistrationToken(user.getEmail(), confirmRegistrationTokenResponse.getToken(), EAuditoryConfirmRegistrationTokenState.ELIMINADO_POR_RENOVACION );
        }else{
            this.confirmRegistrationTokenService.renewConfirmRegistrationToken(user.getEmail(), confirmRegistrationTokenResponse.getToken(), EAuditoryConfirmRegistrationTokenState.ELIMINADO_POR_EXPIRACION_Y_RENOVACION );
        }
